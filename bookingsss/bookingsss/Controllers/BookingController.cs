...
namespace bookingsss.Controllers
{
    ...
    public class BookingController : ControllerBase
    {
        ...
        public BookingController(BookingDbContext context, ILogger<BookingController> logger, IEmailService emailService)
        {
            _context = context;
            _logger = logger;
        ...
        {
            _logger.LogInformation("UpdateStatus called");
